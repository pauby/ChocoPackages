...
$packageName= 'avastfreeantivirus' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://files.avast.com/iavs9x/avast_free_antivirus_setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'avastfreeantivirus*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
