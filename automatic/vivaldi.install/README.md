# ![vivaldi.install](https://cdn.jsdelivr.net/gh/pauby/ChocoPackages@55d09a2/icons/vivaldi.png "Vivaldi Logo") [vivaldi.install](https://chocolatey.org/packages/vivaldi.install)
