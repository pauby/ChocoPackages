...
function global:au_BeforeUpdate() {
    ...
    $Latest.Checksum64 = (Get-FileHash -Path "tools\emacs-$($Latest.SoftwareVersion)-installer_x64.exe" -Algorithm $Latest.ChecksumType64).Hash
}
...
function global:au_GetLatest {
    ...
    return @{
        URL64           = "$releases/emacs-$majorVer/emacs-$softwareVersion-installer.exe"
