...
$packageArgs = @{
    ...
    fileType       = 'exe'       
    url64bit       = 'https://github.com//ShareX/ShareX/releases/download/v12.1.1/ShareX-12.1.1-setup.exe'
    checksum64     = 'ee590a66234c0f1dc57725173eb4c4d3c1babf40c516b64e7d1604eb37f85909'
